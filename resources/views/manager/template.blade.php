            ...
            <ul class="nav navbar-right top-nav pull-right">
                <li class="dropdown auth-drp">
                    <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">
                        <img src="{{url('/')}}/img/user2.png" alt="user_auth" class="user-auth-img img-circle">
                    </a>

                    <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX"
                        data-dropdown-out="flipOutX">
                        <li>
                            <a href="javascript:;"><i class="zmdi zmdi-account"></i><span>Admin</span></a>
                        </li>
                                                ...
                                                <li class="chat-list">
                                                    <div class="chat-body">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"
                                                                     src="{{url('/')}}/img/user1.png" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"
                                                                     src="{{url('/')}}/img/user2.png" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"
                                                                     src="{{url('/')}}/img/user3.png" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"
                                                                     src="{{url('/')}}/img/user4.png" alt="user"/>
                                                                <div class="user-data">
                                    ...
                                    <div class="streamline message-box nicescroll-bar">
                                            ...
                                            <div class="sl-item unread-message">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle"
                                                         src="{{url('/')}}/img/user.png" alt="avatar"/>
                                                </div>
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle"
                                                         src="{{url('/')}}/img/user1.png" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle"
                                                         src="{{url('/')}}/img/user2.png" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item unread-message">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle"
                                                         src="{{url('/')}}/img/user3.png" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item unread-message">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle"
                                                         src="{{url('/')}}/img/user4.png" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
...
<script src="{{url('/')}}/js/vectormap-data.js"></script>

<!-- Data table JavaScript -->
<script src="{{url('/')}}/vendors/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>

<!-- Flot Charts JavaScript -->
<script src="{{url('/')}}/vendors/bower_components/Flot/excanvas.min.js"></script>
...
<script src="{{url('/')}}/vendors/bower_components/Flot/jquery.flot.time.js"></script>
<script src="{{url('/')}}/vendors/bower_components/Flot/jquery.flot.stack.js"></script>
<script src="{{url('/')}}/vendors/bower_components/Flot/jquery.flot.crosshair.js"></script>
...
<script src="{{url('/')}}/js/simpleweather-data.js"></script>
...
<!-- Fancy Dropdown JS -->
<script src="{{url('/')}}/js/dropdown-bootstrap-extended.js"></script>
...
<!-- EChartJS JavaScript -->
<script src="{{url('/')}}/vendors/bower_components/echarts/dist/echarts-en.min.js"></script>
<script src="{{url('/')}}/vendors/echarts-liquidfill.min.js"></script>
...
<input type="hidden" id="site_meta" data-baseurl="{{ url('') }}">
