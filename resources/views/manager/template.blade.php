													...
													<li class="chat-list">
														<div class="chat-body">
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{url('/')}}/img/user.png" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{url('/')}}/img/user1.png" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{url('/')}}/img/user2.png" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{url('/')}}/img/user3.png" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{url('/')}}/img/user4.png" alt="user"/>
																	<div class="user-data">
														...
														<ul class="nicescroll-bar pt-20">
															<li class="friend">
																<div class="friend-msg-wrap">
																	<img class="user-img img-circle block pull-left"  src="{{url('/')}}/img/user.png" alt="user"/>
									...
									<div class="set-height-wrap">
										<div class="streamline message-box nicescroll-bar">
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{url('/')}}/img/user.png" alt="avatar"/>
													</div>
											...
											<a href="javascript:void(0)">
												<div class="sl-item">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{url('/')}}/img/user1.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{url('/')}}/img/user2.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{url('/')}}/img/user3.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{url('/')}}/img/user4.png" alt="avatar"/>
													</div>
													<div class="sl-content">
